...
class BeneficiaresScreenView extends GetView<ServicesScreenController> {
  BeneficiaresScreenView({
    Key? key,
  }) : super(key: key) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
          child: SizedBox(
              width: Get.width, height: Get.height, child: Text('data')
              ...
              //                     );
              //                   }
              //                   // const Text('اشخاص جدد'),
              //                   // const Divider(),
              //                   // controller.newIdentity.isEmpty
              ...
              //                   //             itemCount: controller.newIdentity.length,
              //                   //             itemBuilder: (context, index) {
              //                   //               IdentitBeneficiares identitBeneficiares =
              //                   //                   controller.newIdentity[index];
              //                   //               return CustomerIdentenyItem(
              ...
              //                 label:
              //                     Text(controller.identitSelected.length.toString()),
              //                 child: Icon(
              ...
              //         child: Text('بياتات الاشخاص والمستفيدين',
